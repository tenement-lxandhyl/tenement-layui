        ...
        init: function (target, ops) {
            ...
            if (options.scope) {
                ...
                if ($('#' + options.scope).length>0) {
                    ...
                    var node = $('<div id="' + options.scope + '" class="hotel-filter-list "><strong class="tit">已选</strong><div class="con selected-query"><ul  class="list"><li class="filter-query-clear"><a class="J_FilterQueryClear" href="houses.html">全部清除</a></li></ul></div></div>');
